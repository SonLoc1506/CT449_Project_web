  ...
  <header id="header-admin">
    <nav class="navbar navbar-dark bg-dark p-3">
      <div class="container">
        ...
        <router-link to="/admin" class="navbar-brand fw-bold fs-3">
          TRANG CHỦ
        </router-link>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasWithBackdrop" aria-labelledby="offcanvasWithBackdropLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title fw-bold" id="offcanvasWithBackdropLabel">Admin</h5>
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav">
          ...
          <li class="nav-item" v-if="isLoggedIn" :class="{ 'active': $route.path === '/admin/book' }">
            <router-link to="/admin/book" class="nav-link fw-bold"><i class="fa-solid fa-book"></i>Quản lý sách</router-link>
          </li>
          <li class="nav-item" v-if="isLoggedIn" :class="{ 'active': $route.path === '/admin/borrowBook' }">
            <router-link to="/admin/borrowBook" class="nav-link fw-bold"><i class="fa-solid fa-check"></i>Mượn trả</router-link>
          </li>
          <li class="nav-item" v-if="isLoggedIn" :class="{ 'active': $route.path === '/admin/staff' }">
            <router-link to="/admin/staff" class="nav-link fw-bold"><i class="fa-solid fa-user"></i>Nhân viên</router-link>
          </li>
          <li class="nav-item" v-if="isLoggedIn" :class="{ 'active': $route.path === '/admin/reader' }">
            <router-link to="/admin/reader" class="nav-link fw-bold"><i class="fa-solid fa-users"></i>Độc giả</router-link>
          </li>
          <li class="nav-item" v-if="isLoggedIn" :class="{ 'active': $route.path === '/admin/publisher' }">
